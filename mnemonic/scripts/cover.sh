...
CACHE="$HOME/.covers"
# API Key for Last.fm
APIKEY="8a8bdbef002379363e6c6c1f3d5c3a51"
...
cp $HOME/.conky/mnemonic/img/nocover.png /tmp/conkyCover.png
echo "NoCover" >> $LOG
...
convert /tmp/cover.png $HOME/.conky/mnemonic/img/case.png -composite /tmp/cover.png >> $LOG
# Resize for immediate use
convert /tmp/cover.png -resize 100 /tmp/conkyCover.png >> $LOG
# Set current artist
